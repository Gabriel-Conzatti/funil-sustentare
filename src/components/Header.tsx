        ...
        {open && (
          <>
            ...
            <div className="animate-fade-in absolute right-0 z-20 mt-2 w-56 rounded-lg border border-cyan-signal/20 bg-surface-container p-1 shadow-xl">
              ...
              <button className="flex w-full items-center gap-2 rounded-md px-3 py-2 text-label-md text-content-variant hover:bg-surface-high" onClick={() => { setOpen(false); router.push("/perfil"); }}>
